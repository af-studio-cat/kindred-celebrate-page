...
const Hero = () => {
  return (
    <section className="min-h-screen flex flex-col items-center justify-center px-6 py-20 botanical-pattern relative overflow-hidden">
      ...
      <motion.div
        className="absolute -left-16 md:-left-12 top-1/4 opacity-20"
      ...
      <motion.div
        className="absolute top-16 left-8 md:left-24 opacity-25"
      ...
      {/* Dove - top right */}
      <motion.div
        className="absolute top-20 right-4 md:right-16 opacity-30"
      ...
      <motion.div
        className="absolute -right-8 md:-right-4 top-1/3 opacity-20"
        initial={{ opacity: 0, x: 30 }}
        animate={{ opacity: 0.2, x: 0 }}
      ...
      <motion.div
        className="absolute bottom-40 left-8 md:left-20 opacity-20"
        initial={{ opacity: 0 }}
        animate={{ opacity: 0.2 }}
      ...
      <motion.div
        className="absolute top-1/2 right-4 md:right-12 opacity-25"
      ...
      {/* Daisy - bottom left */}
      <motion.div
        className="absolute bottom-28 left-12 md:left-32 opacity-20"
        initial={{ opacity: 0 }}
        animate={{ opacity: 0.2 }}
      ...
      <motion.div
        className="absolute bottom-24 right-8 md:right-24 opacity-20"
        initial={{ opacity: 0 }}
        animate={{ opacity: 0.2 }}
