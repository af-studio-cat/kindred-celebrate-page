...
import { OliveBranch, LeafSprig } from "./Illustrations";
...
const Celebration = () => {
  ...
  return (
    <Section className="text-center relative overflow-hidden">
      ...
      <div className="absolute top-16 left-4 md:left-12 opacity-25">
        <LeafSprig className="w-12 md:w-16 h-16 md:h-24 rotate-[-20deg]" />
      </div>
